...
import { Flame, Map, BarChart3, Home as HomeIcon, BookOpen } from 'lucide-react';
    ...
    <header className="bg-[#0A1929] text-white px-8 py-4 shadow-lg border-b border-white/10">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          <motion.div
            animate={{ 
              filter: ['drop-shadow(0 0 8px rgba(255, 59, 48, 0.6))', 'drop-shadow(0 0 15px rgba(255, 59, 48, 0.8))', 'drop-shadow(0 0 8px rgba(255, 59, 48, 0.6))']
            }}
